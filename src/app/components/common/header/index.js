			                            ...
			                            <div className="icon-nav">
			                                <ul>
			                                    <li className="onhover-div mobile-search">
			                                        <div><img src={search}  className="img-fluid" alt="" />
			                                            </div>
			                                    ...
			                                    <li className="onhover-div mobile-setting">
			                                        ...
			                                        <div className="show-div setting">
			                                            ...
			                                            <ul>
			                                                ...
			                                                <li><a href={null} >French</a> </li>
			                                            </ul>
			                                            <h6>currency</h6>
			                                            <ul className="list-inline">
			                                                <li><a href={null} >euro</a> </li>
			                                                <li><a href={null} >rupees</a> </li>
			                                                <li><a href={null} >pound</a> </li>
			                                                <li><a href={null} >doller</a> </li>
			                                            </ul>
			                                        </div>
			                                    </li>
