...
export default () => (
  <Page id="Lookbook" title="Lookbook" description="Lookbook page." noCrawl>
    <div>
                    ...
                    <a href="#">
                      <div className="dot-showbox">
                        <img
                          ...
                          }/assets/images/fashion/lookbook/7-a1.jpg`}
                          className="img-fluid"
                          alt=""
                        />
              ...
              <div className="col-12">
                <div className="lookbook-block">
                  <img
                    src={`${
                      process.env.PUBLIC_URL
                    }/assets/images/fashion/lookbook/6.jpg`}
                    alt=""
                    className="img-fluid"
                  />
                    ...
                    <a href="#">
                      <div className="dot-showbox">
                        <img
                          src={`${
                            process.env.PUBLIC_URL
                          }/assets/images/fashion/lookbook/6-a1.jpg`}
                          className="img-fluid"
                          alt=""
                        />
                        <div className="dot-info">
                    ...
                    <a href="#">
                      <div className="dot-showbox">
                        <img
                          src={`${
                            process.env.PUBLIC_URL
                          }/assets/images/fashion/lookbook/6-a2.jpg`}
                          className="img-fluid"
                          alt=""
                        />
                        <div className="dot-info">
              ...
              <div className="col-12">
                <div className="lookbook-block">
                  <img
                    src={`${
                      process.env.PUBLIC_URL
                    }/assets/images/fashion/lookbook/3.jpg`}
                    alt=""
                    className="img-fluid"
                  />
                    ...
                    <a href="#">
                      <div className="dot-showbox">
                        <img
                          src={`${
                            process.env.PUBLIC_URL
                          }/assets/images/fashion/lookbook/3-a2.jpg`}
                          className="img-fluid"
                          alt=""
                        />
                        <div className="dot-info">
              ...
              <div className="col-12">
                <div className="lookbook-block">
                  <img
                    src={`${
                      process.env.PUBLIC_URL
                    }/assets/images/fashion/lookbook/5.jpg`}
                    alt=""
                    className="img-fluid"
                  />
                    ...
                    <a href="#">
                      <div className="dot-showbox">
                        <img
                          src={`${
                            process.env.PUBLIC_URL
                          }/assets/images/fashion/lookbook/5-a2.jpg`}
                          className="img-fluid"
                          alt=""
                        />
                        <div className="dot-info">
                    ...
                    <a href="#">
                      <div className="dot-showbox">
                        <img
                          src={`${
                            process.env.PUBLIC_URL
                          }/assets/images/fashion/lookbook/5-a1.jpg`}
                          className="img-fluid"
                          alt=""
                        />
                        <div className="dot-info">
              ...
              <div className="col-12">
                <div className="lookbook-block">
                  <img
                    src={`${
                      process.env.PUBLIC_URL
                    }/assets/images/fashion/lookbook/4.jpg`}
                    alt=""
                    className="img-fluid"
                  />
                    ...
                    <a href="#">
                      <div className="dot-showbox">
                        <img
                          src={`${
                            process.env.PUBLIC_URL
                          }/assets/images/fashion/lookbook/4-a3.jpg`}
                          className="img-fluid"
                          alt=""
                        />
                        <div className="dot-info">
                    ...
                    <a href="#">
                      <div className="dot-showbox">
                        <img
                          src={`${
                            process.env.PUBLIC_URL
                          }/assets/images/fashion/lookbook/4-a4.jpg`}
                          className="img-fluid"
                          alt=""
                        />
                        <div className="dot-info">
              ...
              <div className="col-12">
                <div className="lookbook-block">
                  <img
                    src={`${
                      process.env.PUBLIC_URL
                    }/assets/images/fashion/lookbook/2.jpg`}
                    alt=""
                    className="img-fluid"
                  />
